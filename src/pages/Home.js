                ...
                <div className="container">
                    <div className="features">
                        <div className="feature-card">
                            ...
                            <a href="/balanceraum/about" className="btn">Mehr erfahren</a>
                        </div>
                        ...
                        <div className="feature-card">
                            ...
                            <a href="/balanceraum/services" className="btn">Zum Angebot</a>
                        </div>

                        <div className="feature-card">
                            <h3>Lageplan</h3>
                            <p>Finden Sie uns in Sünikon - barrierefrei und gut erreichbar.</p>
                            <a href="/balanceraum/location" className="btn">Zur Anfahrt</a>
                        </div>
                    </div>
                </div>
            </section>
